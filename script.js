jQuery(document).ready(function ($) {
        ...
        setTimeout(()=>{
        $('.emoji:eq(0)').css('transform', 'translate(200px,400px) scale(5,5)')
        $('.emoji:eq(1)').css('transform', 'translate(400px,200px) scale(5,5)')
        $('.emoji:eq(2)').css('transform', 'translate(600px,400px) scale(5,5)')
        $('.emoji:eq(3)').css('transform', 'translate(800px,200px) scale(5,5)')
        }, 2000)
